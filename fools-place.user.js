// ==UserScript==
// @name         TomFooleryShow r/place
// @version      0.2.4
// @description  Template overlay for TomFooleryShow.
// @match        https://garlic-bread.reddit.com/embed*
// @grant        GM_xmlhttpRequest
// @credit       https://github.com/destinygg/dgg-place
// @author      UzumakiNaruto
// @description 7/22/2023, 9:00:19 PM
// ==/UserScript==
  ...
  window.addEventListener('load', () => {
      ...
      function refresh(forceRefresh) {
          ...
          GM_xmlhttpRequest({
              method: 'GET',
              responseType: 'blob',
              url: `https://i.imgur.com/EBzjRhW.png`,
